...
public class CarTransporter extends Truck implements ICarStorage {
    ...
    /*
     * It's possible to load/unload the cartransport while it's moving. One solution
     * is to override the methods from Vehicle to Truck which increment/decrement
     * the speed and then add an extra condition before calling the super method.
     * E.g.
     * 
     * @Override void startEngine(){ if(platform.isInValidPosition()){
     * super.startEngine() } else{ ... } }
     */
