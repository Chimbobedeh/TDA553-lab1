...
public class DrawPanel extends JPanel{
    ...
    //Map<Vehicle, BufferedImage> carMap = new HashMap<Car, BufferedImage>();
    // collection that maps car object to BufferedImage
    ...
    void addVehicle(Vehicle vehicle) {
        ...
        carMap.put(vehicle, image);
    }

    BufferedImage getImage(String path) {
        BufferedImage img = ImageIO.read(DrawPanel.class.getResourceAsStream(path));
        return img;
    }
    */
    //CONTROLLER STUFF
